...
namespace ChaHuoBaoWeb.PublickFunction
{
    ...
    /// <summary>HttpHelper的2次封装函数 作者：July
    /// </summary>
    public class MyHttpHelper
    {
        ...
        public static string HttpGet(string url)
        {
            string indata = "";
            string outdata = "";
            string Reg_method = "GET";
            string Reg_Charset = "utf-8";
            ...
            myHttpWebRequest.Method = Reg_method;
            ...
            StreamReader myStreamReader = new StreamReader(myResponseStream, Encoding.GetEncoding(Reg_Charset));
