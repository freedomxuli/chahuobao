...
namespace ChaHuoBaoWeb.WebService
{
    ...
    /// APP_ChaXunGps 的摘要说明
    /// </summary>
    public class APP_ChaXunGps : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                IEnumerable<GpsDevice> GpsDevice = db.GpsDevice.Where(x => x.UserID == UserID);
                if (GpsDevice.Count() > 0)
                {
                    ...
                    CaoZuoJiLu.CaoZuoLeiXing = "GPS管理";
                    CaoZuoJiLu.CaoZuoNeiRong = "APP内用户查询GPS设备列表。";
